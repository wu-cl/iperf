...
struct iperf_test
{
    ...
    cpu_set_t cpumask_init;
    cpu_set_t cpumask_with_affinity;
#elif defined(HAVE_CPUSET_SETAFFINITY)
    cpuset_t cpumask_init;
    cpuset_t cpumask_with_affinity;
#elif defined(HAVE_SETPROCESSAFFINITYMASK)
    DWORD_PTR cpumask_init;
    DWORD_PTR cpumask_with_affinity;
#endif
    char     *title;				/* -T option */
